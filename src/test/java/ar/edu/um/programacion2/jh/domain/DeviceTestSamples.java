...
public class DeviceTestSamples {
    ...
    public static Device getDeviceSample1() {
        return new Device().id(1L).code("code1").name("name1").description("description1").currency("currency1");
    }

    public static Device getDeviceSample2() {
        return new Device().id(2L).code("code2").name("name2").description("description2").currency("currency2");
    }
