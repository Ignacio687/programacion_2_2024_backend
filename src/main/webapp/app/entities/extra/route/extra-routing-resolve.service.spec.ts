...
import extraResolve from './extra-routing-resolve.service';

describe('Extra routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: ExtraService;
  let resultExtra: IExtra | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IExtra returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        extraResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
            resultExtra = result;
          },
        });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultExtra).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IExtra>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
