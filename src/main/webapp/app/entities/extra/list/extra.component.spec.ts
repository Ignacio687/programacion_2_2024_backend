...
import { sampleWithRequiredData } from '../extra.test-samples';
...
describe('Extra Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.extras?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to extraService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getExtraIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getExtraIdentifier).toHaveBeenCalledWith(entity);
