...
import { sampleWithRequiredData } from '../characteristic.test-samples';
...
describe('Characteristic Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.characteristics?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to characteristicService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCharacteristicIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCharacteristicIdentifier).toHaveBeenCalledWith(entity);
